...
class RecommendForMultipleDrinksTest {
    ...
    internal fun `recommend 1 can at 3% abv for 1 unit in 330ml cans`() {
        val recommendations = recommender.recommendMaxAbvAndNumberOfDrinks(AvailableDrinks.can330, 1.0)
    ...
    internal fun `recommend 1 can at 6% abv for 2 units in 330ml cans`() {
        val recommendations = recommender.recommendMaxAbvAndNumberOfDrinks(AvailableDrinks.can330, 2.0)
    ...
    internal fun `recommend 1 metric pint at 4% abv for 2 units in metric pints`() {
        val recommendations = recommender.recommendMaxAbvAndNumberOfDrinks(AvailableDrinks.metricPint, 2.0)
    ...
    internal fun `recommend half pint`() {
        val recommendations = recommender.recommendMaxAbvAndNumberOfDrinks(AvailableDrinks.pint, 5.0)
